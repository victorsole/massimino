...
export async function GET() {
  try {
    ...
    const fallback = [
      ...
      { name: 'Pump Gymwear', url: 'https://pumpgymwear.com/en?utm_source=massimino&utm_medium=partner_band&utm_campaign=pump_gymwear', logoUrl: '/images/pumpgymwear.png', blurb: 'Dutch gym apparel' },
    ];
