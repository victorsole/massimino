...
const nextConfig = {
    ...
    async redirects() {
      const redirects = [
        ...
        {
          source:
            '/:username((?!api|admin|profile|dashboard|messages|teams|exercises|workout-log|terms|privacy|safety|community|massiminos|login|signup|register|unauthorized|partnerships|assessments|my-athletes|bio|cookies|legal|static|uploads|public|images|_next|favicon\\.ico|.*\\..*).+)',
