#!/bin/bash
# NASM CPT Document Conversion Script
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}  NASM CPT Document Conversion${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""
...
if [ "$file_count" -eq 0 ]; then
    ...
    echo "Please add NASM CPT .docx files to convert."
    exit 0
fi
...
echo "3. Enhance structure and extract coaching cues"
echo "4. Run tests: npm test -- nasm_parsing.test.ts"
